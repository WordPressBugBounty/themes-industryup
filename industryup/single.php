...
<main id="content" class="single-class">
  <div class="container">
    <div class="row"> 
    <?php $industryup_single_page_layout = get_theme_mod('industryup_single_page_layout','align-content-right');
      if($industryup_single_page_layout == 'align-content-left'){ ?>
        <div class="col-md-3">
          <?php get_sidebar(); ?>
        </div>
      <?php } 
      if(($industryup_single_page_layout == 'align-content-left') || ($industryup_single_page_layout == 'align-content-right')){ ?>
        <div class="col-md-9">
      <?php } else { ?>
        <div class="col-md-12">
      <?php } ?>
      ...
      <?php if($industryup_single_page_layout == 'align-content-right'){ ?>
        <div class="col-md-3">
          <?php get_sidebar(); ?>
        </div>
      <?php } ?>
